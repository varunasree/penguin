...
## How to run
git clone https://github.com/your-username/penguin-species-clustering.git and open penguin_species_clustering.ipynb in Jupyter after installing requirements.txt
